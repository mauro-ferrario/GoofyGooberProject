...
{
public:
                    GoofyParticle(ofVec3f position = ofVec3f(0,0), float limitVelocity = 10, ofColor color = 255, float spring = ofRandom(.01,.5), float friction = ofRandom(.01,.4), long int life = 0);
